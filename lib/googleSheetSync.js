...
class GoogleSheetSync {
    ...
    async bulkPushStudents(students) {
        ...
        try {
            ...
            url.searchParams.set('data', JSON.stringify({ students }));
    ...
    async bulkPushAssessments(assessments) {
        ...
        try {
            ...
            url.searchParams.set('data', JSON.stringify({ assessments }));
    ...
    async bulkPushAttendance(attendance) {
        ...
        try {
            ...
            url.searchParams.set('data', JSON.stringify({ attendance }));
